...
For task 3.4
Form previous meeting we decided that part of this task should be about coordinating and helping ExPaNDS partners so that they could achive the KPI targets. In order to help the facilites we need to understand the problems they have. The information we need from each facilities are:
